...
public class TransferController {
    ...
    public String recipientEdit(@RequestParam(value = "recipient-name") String recipientName, Model model, Principal principal){
    ...
    @Transactional
    public String recipientDelete(@RequestParam(value = "recipient-name") String recipientName, Model model, Principal principal){
